...
export default function StudentsEditCard({ id, direction,urlDirection }) {
    ...
    return (
        <div>
            ...
            <div className='response-students'>
                <Link href={"/admin/studentsWorks/newStudentWork?" + id + "&" + urlDirection} >
                ...
                {studentsWork.map((el) => (
                    <Link href={"/admin/studentsWorks/" + el.id + "?" + urlDirection} key={el.id}>
